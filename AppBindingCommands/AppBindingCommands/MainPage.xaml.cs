...
namespace AppBindingCommands
{
    public partial class MainPage : ContentPage
    {
        ...
        {
            //Properties é tipo um dicionario de "chave = valor"
            // Application.Current.Properties.ContainsKey("") -> verifica se a variavel existe
            //Application.Current.Properties[""] -> pega o valor
